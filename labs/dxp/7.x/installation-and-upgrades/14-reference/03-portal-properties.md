...
> For more database configuration details, see [Configuring a Database](../installing-liferay-dxp-on-premises/configuring-a-database.md) and [Database Templates](./05-database-templates.md).
