...
.. toctree::
   ...
   user-guide/catalog/managing-channels.md
   user-guide/catalog/configuring-product-visibility-by-site-using-channels.md


   user-guide/catalog/introduction-to-product-types.md
   user-guide/catalog/creating-a-simple-product.md
   user-guide/catalog/creating-a-grouped-product.md
   user-guide/catalog/creating-a-virtual-product.md
   user-guide/catalog/virtual-product-reference.md
   user-guide/catalog/customizing-your-product-with-product-options.md
   user-guide/catalog/adding-skus-to-your-products.md
   user-guide/catalog/product-images.md
   user-guide/catalog/specifications.md
   ...
   user-guide/catalog/availability-estimates.md
   user-guide/catalog/product-inventory-configuration-reference.md

   user-guide/catalog/introduction-to-product-pricing-methods.md
   user-guide/catalog/setting-a-products-base-price.md
   user-guide/catalog/creating-a-price-list.md
   user-guide/catalog/adding-products-to-a-price-list.md
   user-guide/catalog/adding-tiered-pricing.md

   user-guide/marketing/automating-store-emails-by-using-notification-templates.md
   user-guide/marketing/adding-discounts-by-product.md
   ...
   user-guide/content/checkout.md
   user-guide/content/compare.md
   user-guide/content/list.md
   user-guide/content/pending-orders.md
   user-guide/content/placed-orders.md
   user-guide/content/product-details.md
   user-guide/content/search.md
   ...
   user-guide/customers/introduction-to-accounts.md
   user-guide/customers/creating-a-new-account.md
   ...
   user-guide/sales/mercanet.md
   user-guide/sales/money-orders.md
   user-guide/sales/paypal.md

   user-guide/sales/using-fedex-as-a-carrier-method.md
   user-guide/sales/using-the-flat-rate-shipping-method.md
   user-guide/sales/using-the-variable-rate-shipping-method.md
   user-guide/sales/applying-shipping-method-restrictions.md
   user-guide/sales/measurement-units.md
   user-guide/sales/shipping-method-reference.md

   user-guide/sales/order-life-cycle.md
   ...
   user-guide/sales/introduction-to-shipments.md
   user-guide/sales/creating-a-shipment.md
   user-guide/sales/cancelling-a-shipment.md
