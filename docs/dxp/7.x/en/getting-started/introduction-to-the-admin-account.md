...
1. Click the _Sign In_ link.
    ...
    > **Note:** If a Liferay DXP bundle is being used, you may be presented with the [_Setup Wizard_](../installation-and-upgrades/installing-liferay-dxp-on-premises/running-liferay-dxp-for-the-first-time.md). Follow the on-screen instructions to configure your Admin user.
